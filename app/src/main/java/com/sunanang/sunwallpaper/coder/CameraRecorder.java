package com.sunanang.sunwallpaper.coder;
...
//        mHeadInfo=null;
    ...
    public void stop(Activity activity, boolean firstShared){
        try {
            synchronized (LOCK){
                if(activity != null && firstShared){
                    SharedUtils.setFirstShared(activity,false);
                    //重启这个activity
